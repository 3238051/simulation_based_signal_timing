...
# @Date: 2020-07-08 17:38:36
# @LastEditTime: 2020-08-16 16:28:43
...
add_file = r"C:\Users\LEGION\Desktop\DRLSignalControl\YunLiangHeArtery_GuanghuaToQididajie\sumo_files\YunLiangHeArtery_GuanghuaToQididajie.add.xml"
rou_file = r"C:\Users\LEGION\Desktop\DRLSignalControl\YunLiangHeArtery_GuanghuaToQididajie\sumo_files\YunLiangHeArtery_GuanghuaToQididajie.rou.xml"
...
edge_speedliminfo = {edge_rid:simnet.getEdge(edge_id).getSpeed() for edge_id in edge_ids}
...
with open('C:/Users/LEGION/Desktop/DRLSignalControl/YunLiangHeArtery_GuanghuaToQididajie/result/方案枚举.txt','w',newline="") as f:    
    for plan in planset:
        ...
        res = eval_plan(cfg_file,add_file,rou_file,mode='sumo')
        f.write(str(cycle)+' ')
        f.write(str(offsets)+' ')
        f.write(str(res))
        f.write('\n')
